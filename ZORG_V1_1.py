...
#
# Written by    - Serial Connection: Alessandro Tellini    (tellini@arch.ethz.ch)
#               - Main Code:         Daniel Bachmann       (daniel.bachmann@arch.ethz.ch)
#
...
#
# Prerequisites:
# The Script is depending on pyserial to send commands to the Zuend-Machine.
# Make sure you have copied the serial folder of pyserial to the same directory where the ZORG script resides.
...
maxWSPx=1601            #Max Workspace Coordinate X-Axis in mm
maxWSPy=1301            #Max Workspace Coordinate Y-Axis in mm
